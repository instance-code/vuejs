<div class="container mt-4"> 
    ...
    <form action="{{ route('blog.update', ['blog' => $blog->id] )}}" method="POST"> 
        ...
        <div class="form-group row">
            ...
            <input type="text" name="title" id="title" class="form-control col-sm-10" value="{{$blog->title}}">
        </div>

        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="content">@lang('lang.blog_content')</label>
            <textarea name="content" id="content" class="form-control col-sm-10"> {{$blog->content}} </textarea>
        </div>

        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="created_by">@lang('lang.created_by')</label> 
            <input type="text" name="created_by" id="created_by" class="form-control col-sm-10" value="{{$blog->created_by}}">
        </div>

        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="updated_by">@lang('lang.updated_by')</label> 
            <input type="text" name="updated_by" id="updated_by" class="form-control col-sm-10" value="{{$blog->updated_by}}">
        </div>
